        ...
        <>
            ...
            <div className={Style.wrapSecurity}>
                ...
                <div className={`${Style.items} ${Style.item2}`}>
                    <img src={dataRecording} alt="Animowana tarcza z kłódką" />
                ...
                <div className={`${Style.items} ${Style.item3}`}>
                    <img src={encryption} alt="Kłódka do której ładują sie dane" />
                ...
                <div className={`${Style.items} ${Style.item4}`}>
                    <img src={downloadSummary} alt="Animacja pobieranych danych" />
